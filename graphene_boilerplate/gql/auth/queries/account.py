"""from graphene_boilerplate.model.user import User
from graphene_boilerplate.gql.auth.fields import AccountField, ResponseMessageField, AccountResults
...
def resolve_account(root, info, **kwargs):
    ...
    accounts = User.objects(id=id, username=username)
